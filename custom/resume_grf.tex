...
\begin{document}
    ...
    \section{Research Interests}
        \begin{spacing}{1.3}
        \begin{onecolentry}
            My research is focused on \textbf{developing and evaluating culturally-aware AI technologies} for high-impact areas such as education.  Broadly, I am interested in \textbf{Human-Computer Interaction}, \textbf{Human-AI Interaction}, \textbf{Responsible AI}, \textbf{Learning Sciences}, and \textbf{ICT for Development}. 
        \end{onecolentry}
        \end{spacing}
    \vspace{-0.11 cm}
    ...
    \section{Ongoing Research Projects}
        \researchprojectentry{Evaluation of Cultural Alignment of Indic-LLMs}{Cornell University \& Microsoft Research}
            \begin{onecolentry}
                \begin{highlights}
                    \item Conducting a quantitative study to assess the cultural alignment of Indic LLMs across various Indian languages and their correspondence with Indian cultural values.
                \end{highlights}
            \end{onecolentry}
