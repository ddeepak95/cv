...
\begin{document}
    ...
    \section{Research Interests}
        \begin{spacing}{1.3}
        \begin{onecolentry}
            My research is focused on \textbf{developing and evaluating culturally-aware AI technologies} to improve the quality of learning equitably.  Broadly, I am interested in \textbf{Human-Computer Interaction}, \textbf{Human-AI Interaction}, \textbf{Responsible AI}, \textbf{Learning Sciences}, and \textbf{ICT for Development}. 
        \end{onecolentry}
        \end{spacing}
    \vspace{-0.11 cm}
